 ...
 */
public class ApnsHttp2PushNotification implements IApnsPushNotification {
	...
	public ApnsHttp2PushNotification(final String token, final String topic, final String payload,
			final Date invalidationTime) {
		this(token, topic, payload, invalidationTime, DeliveryPriority.IMMEDIATE);
	}

	public ApnsHttp2PushNotification(String token, final String topic, String payload, Date invalidationTime,
