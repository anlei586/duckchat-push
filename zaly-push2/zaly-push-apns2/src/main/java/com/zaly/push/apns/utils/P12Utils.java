...
public class P12Utils {
	...
	public static KeyStore.PrivateKeyEntry getFirstPrivateKeyEntryFromP12InputStream(final KeyStore keyStore,
	...
	public static KeyStore loadPCKS12KeyStore(final InputStream p12InputStream, final String password)
	...
	public static ArrayList<String> getIdentitiesForP12File(final KeyStore keyStore)
			throws KeyStoreException, IOException {
		final Enumeration<String> aliases = keyStore.aliases();
